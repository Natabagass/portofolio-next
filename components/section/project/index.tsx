        ...
        <div className="mx-content font-jakartaSans mt-80">
            <div className="flex flex-col w-full">
                <span className="relative mt-2 inline-block sm:mt-0 z-">
                    ...
                    <span className="title-highlight absolute left-[80px] -bottom-1 -z-10 hidden h-[15px] w-[250px] max-[350px]:w-[220px] min-[375px]:block sm:bottom-2 sm:w-[320px] md:bottom-1 lg:h-[10px] lg:w-[560px]"></span>
                </span>

                <h3 className="text-white mt-10 text-2xl w-[70%] z-20">
