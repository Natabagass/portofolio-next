export const data = [
    {
        ...
        responsibilites: [
            {
                desc: 'Migration Torche Web using MERN stack method'
            },
            {
                desc: 'Creating a registration class for torche'
            }
        ]
    },
    {
        ...
        responsibilites: [
            {
                desc: 'Creating website using Next.Js, TypeScript, and Tailwind'
            },
            {
                desc: 'Implementing Data Strategy Fetching with ISR, SSR, and CSR'
            }
        ]
    }
]